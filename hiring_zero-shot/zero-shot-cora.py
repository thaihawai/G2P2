...
def main(args):
    ...
    for j in range(len(task_list)):
        ...
        # print(len(test_idx[j]))
        # print(similarity.argsort())
        print(pred)
        raise()
...
if __name__ == '__main__':
    ...
    # TODO: get the list of unlabeled nodes and using above zero shot to pred them
    # TODO: then add this unlabeled pseudo labeled nodes to the training set to train in the file main_test
